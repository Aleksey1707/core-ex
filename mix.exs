defmodule Core.MixProject do
  ...
  defp deps do
    [
      ...
      {:prom_ex, "~> 1.11"},
      # Пропагация трейса. Без SDK у потребителя вызовы API — no-op,
      # экспортёров и коллекторов зависимость не тянет.
      {:opentelemetry_api, "~> 1.4"},
      # SDK — только тестам библиотеки: у потребителя он свой (см. README).
