defmodule Blind.Ping do
  @moduledoc "Корректный агрегат, у кодека которого нет событий с нагрузкой."

  alias Blind.Ping.Event

  use Core.Es.Aggregate,
    event_codec: Blind.Ping.Event.Codec
  ...
  @impl true
  def evolve(state, %Event.Pinged{}), do: %{state | count: state.count + 1}
