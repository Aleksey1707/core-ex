...
Плейсхолдеры: `MyApp` — см. `10-architecture.md`. Метрики outbox и MQ — `14-events-outbox.md`.
...
Контекст трейса живёт в **process dictionary** вызывающего. Из этого следует всё
остальное:
